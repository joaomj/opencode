...
|-----------|-------------|
| gdd-first | Goal-Driven Development: transform tasks into verifiable goals with tests as guardrail. Bug fixes require failing test that reproduces the bug. |
...
| C4 model / C4 architecture / C4 diagram / system context / container / component | `c4-diagram` |
...
| OC006 | Process | GDD: define success criteria (failing test) before implementation |
